from tkinter import *
from import_csv import get_all_chapters, add_lesson, get_name_lessons, delete_lesson, add_chapter, delete_chapter
from pdf_opener import recup_path, copy_file, delete_file
